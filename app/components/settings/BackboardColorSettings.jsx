                ...
                editingId === color._id.toString() ? (
                  <tr key={color._id.toString()} style={{ borderBottom: '1px solid #f0f0f0', background: '#f9f9f9' }}>
                    <td colSpan="5" style={{ padding: '16px' }}>
                      <fetcher.Form method="post" onSubmit={handleUpdateColor}>
                        <input type="hidden" name="action" value="updateBackboardColor" />
                  ...
                  <tr key={color._id.toString()} style={{ borderBottom: '1px solid #f0f0f0' }}>
                    ...
                    <td style={{ padding: '16px', textAlign: 'right' }}>
                      <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
                        <button type="button" onClick={() => handleEditClick(color)} style={{ padding: '6px 12px', background: 'white', color: '#666', border: '1px solid #ddd', borderRadius: '4px', cursor: 'pointer', fontSize: '13px', fontWeight: 500, fontFamily: 'system-ui, -apple-system, sans-serif' }}>Edit</button>
